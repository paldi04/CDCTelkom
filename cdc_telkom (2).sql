...
CREATE TABLE `event` (
  ...
  `e_gambar` varchar(100) NOT NULL,
  `e_petugas` varchar(30) NOT NULL,
  `e_judul` varchar(100) NOT NULL,
  `e_kategori` varchar(100) NOT NULL,
  `e_headline` varchar(100) NOT NULL
...
INSERT INTO `event` (`e_id`, `e_gambar`, `e_petugas`, `e_judul`, `e_kategori`, `e_headline`) VALUES
(157751707300369906, '157751707299897408.jpg', 'eeddad', 'sdvsd', 'vdsvsd', 'vdsvsd');
...
INSERT INTO `kota` (`id_kota`, `id_prov`, `nama`, `id_jenis`) VALUES
...
CREATE TABLE `lowongan` (
  ...
  `low_posisi` varchar(30) NOT NULL,
  ...
  `low_status` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `lowongan` (`low_id`, `low_company`, `low_posisi`, `low_jenjang`, `low_jurusan`, `low_level`, `low_syarat`, `low_syarat_khusus`, `low_info`, `low_jumlah`, `low_valid_until`, `low_kategori`, `low_image`, `low_status`, `low_create`, `low_update`) VALUES
(157753532920668506, 1, 'Tukang Ketik', 'S1', '[\"S1 Teknik Telekomunikasi\",\"S2 Manajemen\",\"D3 Rekayasa Perangkat Lunak Aplikasi\"]', 'Senior', '<p>afdsf</p>', '<p>dsfdg</p>', '<p>fgfg</p>', 11, '2020-02-20', 0, '', 0, '2019-12-28 12:15:29', '2019-12-28 14:32:29');
...
CREATE TABLE `tampilan` (
  `tampil_id` bigint(20) NOT NULL,
  `tampil_label` varchar(60) NOT NULL,
  `tampil_type` char(1) NOT NULL COMMENT 'S, V, T, K, C, E',
  `tampil_file` text NOT NULL COMMENT '{"img":"asd.jpg"}',
  `tampil_data` text NOT NULL COMMENT '{"judul":"abc","desc":"bla bla bla"}',
  `tampil_us_created_id` bigint(20) NOT NULL,
  `tampil_created_by` bigint(20) NOT NULL,
  `tampil_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `tampil_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tampilan` (`tampil_id`, `tampil_label`, `tampil_type`, `tampil_file`, `tampil_data`, `tampil_us_created_id`, `tampil_created_by`, `tampil_create`, `tampil_update`) VALUES
(157737576398338699, '', 'S', '157737576397670292.jpg', '', 0, 1, '2019-12-26 15:56:03', '2019-12-26 15:56:03'),
(157738236277832293, '', 'V', 'https://www.youtube.com/vvds', '\"\"', 0, 1, '2019-12-26 18:10:41', '2019-12-26 18:10:41'),
(157738564746543097, '', 'T', '', '{\"nama\":\"sdf\",\"pesan_kesan_testimoni\":\"sdfsdfd\"}', 0, 1, '2019-12-26 18:40:47', '2019-12-26 18:40:47'),
(157739214780863904, '', 'K', '', '{\"gambar\":\"157739330397733497.jpg\",\"deskripsi\":\"Test\",\"negara\":\"taset\",\"provinsi\":\"asf\",\"kota\":\"asd\"}', 0, 1, '2019-12-26 20:48:23', '2019-12-26 20:48:23'),
(157739395629743599, '', 'C', '', '{\"gambar\":\"157739455685915303.jpg\",\"info\":\"cc\"}', 0, 1, '2019-12-26 21:09:16', '2019-12-26 21:09:16');
...
CREATE TABLE `users` (
  ...
  `us_type` int(11) NOT NULL COMMENT '0 = Admin 1 = Job 2 = Company',
  `us_data` bigint(20) NOT NULL DEFAULT '0' COMMENT 'id company/jobseeker',
...
INSERT INTO `users` (`us_id`, `us_email`, `us_pass`, `us_password`, `us_type`, `us_data`, `us_status`, `us_create`, `us_update`) VALUES
(1, 'admin@admin.admin', '21232f297a57a5a743894a0e4a801fc3', 'YWRtaW4=', 0, 1, 1, '2019-12-26 07:40:28', '2019-12-26 07:40:28'),
(2, 'company@company.company', '21232f297a57a5a743894a0e4a801fc3', 'YWRtaW4=', 2, 1, 1, '2019-12-26 07:40:30', '2019-12-26 07:40:30'),
(3, 'maha@job.job', '21232f297a57a5a743894a0e4a801fc3', 'YWRtaW4=', 1, 1, 1, '2019-12-26 07:40:33', '2019-12-26 07:40:33'),
(4, 'alumni@job.job', '21232f297a57a5a743894a0e4a801fc3', 'YWRtaW4=', 1, 2, 1, '2019-12-26 07:40:35', '2019-12-26 07:40:35');
...
CREATE TABLE `users_admin` (
  ...
  `a_nama` varchar(40) NOT NULL,
  `a_tmpt_lahir` varchar(20) NOT NULL,
  `a_tgl_lahir` varchar(12) NOT NULL,
  `a_gender` char(1) NOT NULL,
  `a_nohp` varchar(15) NOT NULL,
  `a_jenis` varchar(20) NOT NULL DEFAULT '-' COMMENT 'Multi, nasional, lokal',
  `a_bidang` varchar(80) NOT NULL DEFAULT '-',
  `a_prov` varchar(20) NOT NULL,
  `a_kota` varchar(20) NOT NULL,
  `a_alamat` text NOT NULL,
  `a_image` varchar(28) NOT NULL,
  `a_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `users_admin` (`a_id`, `a_nama`, `a_tmpt_lahir`, `a_tgl_lahir`, `a_gender`, `a_nohp`, `a_jenis`, `a_bidang`, `a_prov`, `a_kota`, `a_alamat`, `a_image`, `a_create`, `a_update`) VALUES
(1, 'Mang Admin', 'bandung', '12-12-2012', 'L', '082219285155', '-', '-', 'JAWA BARAT', 'BANDUNG', 'jln. Jalan', '', '2019-12-23 15:29:50', '2019-12-23 15:46:53');
...
CREATE TABLE `users_company` (
  ...
  `uscom_image` varchar(28) NOT NULL,
  `uscom_status` int(11) NOT NULL,
...
INSERT INTO `users_company` (`uscom_id`, `uscom_nama_com`, `uscom_tmpt_berdiri`, `uscom_tgl_berdiri`, `uscom_nohp`, `uscom_jenis`, `uscom_bidang`, `uscom_telepon`, `uscom_prov`, `uscom_kota`, `uscom_alamat`, `uscom_image`, `uscom_status`, `uscom_create`, `uscom_update`) VALUES
(1, 'Chatat.id', 'Bandung', '12-12-2012', '082211112222', 'Lokal', 'Software House', '02243984', 'Jawa Barat', 'KAB. ACEH SELATAN', 'jln. ', '157746548260391402.jpg', 0, '2019-12-18 17:58:48', '2019-12-28 15:25:46'),
(157751849642987489, 'sdfdsf', 'dsfsdf', '02-02-2020', '0814134324', 'Nasional', 'sfaf', '02129179934', 'Banten', 'KAB. ACEH SELATAN', 'reog', '157751849642379498.jpg', 0, '2019-12-28 07:34:56', '2019-12-28 07:34:56');
...
CREATE TABLE `users_jobseeker` (
  ...
  `usjob_jenjang` varchar(10) NOT NULL,
  `usjob_prog_study` varchar(40) NOT NULL,
  `usjob_thn_msk` int(11) NOT NULL,
  `usjob_thn_lls` int(11) NOT NULL,
  `usjob_stat_mahasiswa` int(11) NOT NULL DEFAULT '0' COMMENT '0 : Mahasiswa 1 : Alumni',
  `usjob_stat_data` int(11) NOT NULL DEFAULT '0' COMMENT '0 : belum terisi 1: selesai',
  `usjob_image` varchar(28) NOT NULL,
...
INSERT INTO `users_jobseeker` (`usjob_id`, `usjob_nama`, `usjob_nim`, `usjob_tmpt_lahir`, `usjob_tgl_lahir`, `usjob_nohp`, `usjob_gender`, `usjob_prov`, `usjob_kota`, `usjob_alamat`, `usjob_ktp`, `usjob_profesi`, `usjob_jenjang`, `usjob_prog_study`, `usjob_thn_msk`, `usjob_thn_lls`, `usjob_stat_mahasiswa`, `usjob_stat_data`, `usjob_image`, `us_create`, `us_update`) VALUES
(1, 'Beny', 333222111, 'KOTA BANDUNG', '12-12-1992', '082233332222', 'L', 'Jawa Barat', 'KOTA BANDUNG', 'jln. Jln', '1231241251224', 'Freelancer', '', 'abc', 2019, 0, 0, 1, '', '2019-12-18 18:01:00', '2019-12-27 13:52:49'),
(2, 'Benoy s', 333222111, 'KOTA BANDUNG', '12-12-1992', '082233332222', 'L', 'Jawa Barat', 'KOTA BANDUNG', 'jln. Jln', '1231241251224', 'Freelancer', '', 'abc', 2015, 2019, 1, 1, '', '2019-12-18 18:01:00', '2019-12-27 12:55:11');
...
--
ALTER TABLE `lowongan`
  MODIFY `low_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483647;
...
--
ALTER TABLE `tampilan`
  MODIFY `tampil_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483647;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `us_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `users_jobseeker`
--
ALTER TABLE `users_jobseeker`
  MODIFY `usjob_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
